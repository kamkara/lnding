class ResultatsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @resultat.save
        format.html { redirect_to @resultat, notice: "votre résultat bien envoyé." }
  ...
  def destroy
    @resultat.destroy
    respond_to do |format|
      format.html { redirect_to admin_path, notice: "Resultat was successfully destroyed." }
  ...
  private
    ...
    def set_resultat
      @resultat = Resultat.friendly.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def resultat_params
      params.require(:resultat).permit(:username, :ville, :ecole, :serie, :feeedback, :genre, :age, :contact, :contact_parent, :status, :slug)
    end
end
